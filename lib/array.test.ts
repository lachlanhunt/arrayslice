...
describe("Array prototype method", function () {
    ...
    it(".find() should search for a value only within the slice", function () {
        const a = [7, 0, 5, 1, 4, 2, 8, 3, 6, 9];
        const b = ArraySlice(a, 3, 8);

        const c = b.find(function (n) {
            return n >= 3 && n <= 5;
        });
    ...
    it(".findIndex() should ", function () {
        ...
        const c = b.findIndex(function (n) {
            return n === 5;
        });
 ...
 */
    ...
    it(".pop() should ", function () {
        ...
        expect(() => b.pop()).toThrow("Cannot call pop method on ArraySlice instances");
    });
    ...
    it(".push() should throw a TypeError", function () {
        ...
        expect(() => b.push()).toThrow("Cannot call push method on ArraySlice instances");
    });
    /*
...
*/
    it(".shift() should ", function () {
        ...
        expect(() => b.shift()).toThrow("Cannot call shift method on ArraySlice instances");
    });
    /*
...
*/
    it(".unshift() should ", function () {
        ...
        expect(() => b.unshift()).toThrow("Cannot call unshift method on ArraySlice instances");
    });
    /*
